...
public class AccountControllerTest extends DummyObject {
    ...
    public void setUp() {
        ...
        User ronaldo = userRepository.save(newUser("ronaldo", "호날두"));
        Account jshAccount1 = accountRepository.save(newAccount(1111L, jsh));
        Account ronaldoAccount1 = accountRepository.save(newAccount(2222L, ronaldo));
        em.clear();
    }
    ...
    // DB에서 username을 조회해서 세션에 담아주는 어노테이션
    @WithUserDetails(value = "jsh", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @Test
